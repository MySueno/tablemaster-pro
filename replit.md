...
- 25 files, ~51KB ZIP, current version 1.2.3
...
- Elementor integration: custom widget (class-elementor.php + class-elementor-widget.php), CSS overrides for editor/preview, table selector dropdown, style controls (max-width, font-size, alignment)
- Key files: `tablemaster-pro.php` (main), `includes/class-updater.php` (auto-update checker), `templates/table-frontend.php` (frontend rendering), `assets/css/frontend.css` (styling), `assets/js/admin.js` (admin editor), `assets/css/admin.css` (admin styling), `includes/class-elementor.php` (Elementor integration), `includes/class-elementor-widget.php` (Elementor widget)
